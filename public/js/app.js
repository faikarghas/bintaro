...
$(document).ready(function () {
  ...
  var item_percentage2 = 100 / 5;

  for (var i = 0; i < 5; i++) {
    $('.dts-2').append("<div class=\"dots_custom-item dts-2-item\" style=\"width:".concat(item_percentage2, "%\"></div>"));
  }
  ...
  var item_percentage3 = 100 / 1;

  for (var _i = 0; _i < 4; _i++) {
    $('.dts-partner1').append("<div class=\"dots_custom-item dts-partner1-item\" style=\"width:".concat(item_percentage3, "%\"></div>"));
  }
  ...
  $('.show-modal').each(function (params) {
    $(this).on('click', function (params) {
      ...
      $("#".concat(idModal)).css('visibility', 'visible');
      $("#".concat(idModal)).css('opacity', '1');
    });
  });
  $('.close-modal').each(function (params) {
    $(this).on('click', function (params) {
      var idModal = $(this).data('modal');
      $("#".concat(idModal)).css('visibility', 'hidden');
      $("#".concat(idModal)).css('opacity', '0');
    });
  }); ////////////////////////////////
